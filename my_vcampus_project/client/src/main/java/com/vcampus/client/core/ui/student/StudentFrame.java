...
public class StudentFrame extends JFrame {
    ...
    private JPanel createTopPanel() {
        ...
        lblStudentName = new JLabel(userData.get("userName").toString());
        ...
        userInfoPanel.add(lblStudentName);
        userInfoPanel.add(lblStudentId);
    ...
    private JTabbedPane createTabbedPane() {
        ...
        pane.addTab("课程管理", coursePanel);

        // 图书借阅面板
        JPanel libraryPanel = createLibraryPanel();
        pane.addTab("图书借阅", libraryPanel);

        // 校园商城面板
        JPanel shopPanel = createShopPanel();
        pane.addTab("校园商城", shopPanel);
    ...
    private JPanel createCoursePanel() {
        ...
        JLabel placeholder = new JLabel("课程管理功能正在开发中...", SwingConstants.CENTER);
    ...
    private JPanel createLibraryPanel() {
        ...
        JLabel titleLabel = new JLabel("图书借阅");
        titleLabel.setFont(new Font("微软雅黑", Font.BOLD, 18));
        panel.add(titleLabel, BorderLayout.NORTH);

        JLabel placeholder = new JLabel("图书借阅功能正在开发中...", SwingConstants.CENTER);
        placeholder.setFont(new Font("微软雅黑", Font.PLAIN, 16));
        placeholder.setForeground(Color.GRAY);
        panel.add(placeholder, BorderLayout.CENTER);
    ...
    private JPanel createShopPanel() {
        ...
        JLabel placeholder = new JLabel("校园商城功能正在开发中...", SwingConstants.CENTER);
        placeholder.setFont(new Font("微软雅黑", Font.PLAIN, 16));
        placeholder.setForeground(Color.GRAY);
        panel.add(placeholder, BorderLayout.CENTER);
