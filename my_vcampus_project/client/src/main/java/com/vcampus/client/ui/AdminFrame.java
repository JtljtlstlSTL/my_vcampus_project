...
public class AdminFrame extends JFrame {
    ...
    public AdminFrame(NettyClient nettyClient, Map<String, Object> userData) {
        ...
        log.info("管理员主界面初始化完成: {}", userData.get("userName"));
    }
    ...
    private JTabbedPane createTabbedPane() {
        ...
        pane.addTab("用户管理", userMgmtPanel);

        // 数据管理面板
        JPanel dataMgmtPanel = createDataManagementPanel();
        pane.addTab("数据管理", dataMgmtPanel);
    ...
    private JPanel createUserManagementPanel() {
        ...
        JButton btnResetPassword = new JButton("重置密码");
        ...
        // 用户列表
        String[] columnNames = {"用户ID", "姓名", "角色", "状态", "最后登录时间"};
        Object[][] data = {
                {"2021001", "张三", "学生", "活跃", "2024-01-15 14:30:00"},
                {"2021002", "李四", "学生", "活跃", "2024-01-15 13:45:00"},
                {"T001", "王老师", "教师", "活跃", "2024-01-15 15:20:00"},
                {"A001", "管理员", "管理员", "活跃", "2024-01-15 16:00:00"}
        };
    ...
    private JPanel createDataManagementPanel() {
        ...
        JLabel titleLabel = new JLabel("数据管理");
        titleLabel.setFont(new Font("微软雅黑", Font.BOLD, 18));
        panel.add(titleLabel, BorderLayout.NORTH);
        ...
        JButton btnStudentData = new JButton("学生数据");
        btnStudentData.setFont(new Font("微软雅黑", Font.PLAIN, 14));

        JButton btnStaffData = new JButton("教职工数据");
        btnStaffData.setFont(new Font("微软雅黑", Font.PLAIN, 14));

        JButton btnCourseData = new JButton("课程数据");
        btnCourseData.setFont(new Font("微软雅黑", Font.PLAIN, 14));

        JButton btnLibraryData = new JButton("图书数据");
        btnLibraryData.setFont(new Font("微软雅黑", Font.PLAIN, 14));

        JButton btnShopData = new JButton("商城数据");
        btnShopData.setFont(new Font("微软雅黑", Font.PLAIN, 14));

        JButton btnSystemData = new JButton("系统数据");
        btnSystemData.setFont(new Font("微软雅黑", Font.PLAIN, 14));

        buttonPanel.add(btnStudentData);
        buttonPanel.add(btnStaffData);
        buttonPanel.add(btnCourseData);
        buttonPanel.add(btnLibraryData);
        buttonPanel.add(btnShopData);
        buttonPanel.add(btnSystemData);
