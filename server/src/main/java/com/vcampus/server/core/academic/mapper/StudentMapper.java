...
public interface StudentMapper {
     ...
     * 获取所有学生信息（包含用户基本信息）
     */
    @Select("SELECT s.cardNum, s.student_Id as studentId, s.EnrollmentYear as enrollmentYear, s.Major as major, s.Department as department, " +
     ...
     * 插入学生信息到tblstudent表
     */
    @Insert("INSERT INTO tblStudent (cardNum, student_Id, EnrollmentYear, Major, Department) " +
            "VALUES (#{cardNum}, #{studentId}, #{enrollmentYear}, #{major}, #{department})")
     ...
     * 更新学生信息
     */
    @Update("UPDATE tblStudent SET student_Id = #{studentId}, EnrollmentYear = #{enrollmentYear}, " +
